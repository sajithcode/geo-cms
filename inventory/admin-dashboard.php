...
try {
    ...
    // Categories
    $stmt = $pdo->query("SELECT COUNT(*) as total_categories FROM inventory_categories");
            ...
            <div class="page-content">
                ...
                <div class="page-header">
                    <div class="page-title">
                        ...
                        <p>Complete inventory control and analytics</p>
                    </div>
                    ...
                    <div class="quick-actions-grid">
                        ...
                        <div class="action-card" onclick="generateReport()">
                            ...
                            <div class="action-text">
                                ...
                                <p>Create detailed inventory reports</p>
                            </div>
                        </div>
